...
function ENT:Initialize()
    ...
    DMU.Add3D2DPos(self:EntIndex(), self:GetPos(), "hold_zone_" .. self.Identifier .. ".png")
...
function ENT:Think()
    ...
    elseif self.HoldProgress >= 100 and self.Team == -1 then
        ...
        self.HoldProgress = 0
        DMU.Add3D2DPos(self:EntIndex(), self:GetPos(), "hold_zone_" .. self.Identifier .. ".png", team.GetColor(biggest_team))
    end
